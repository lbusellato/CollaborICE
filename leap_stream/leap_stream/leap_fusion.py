...
from leap_stream.lib_fusion import separate_hands, fuse_hand, rotations_top_hand
...
class LeapFusion(Node):
    ...
    def __init__(self):
        ...
        self.subscription1 = self.create_subscription(String, '/leap/streamer/desk', self.listener_callback_1, 1)
        self.subscription2 = self.create_subscription(String, '/leap/streamer/screen', self.listener_callback_2, 1)
        ...
        self.publisher_ = self.create_publisher(String, '/leap/fusion', 1)
