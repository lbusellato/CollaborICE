...
class LeapSubscriberNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('min_hand_confidence', 0.80)
        self.min_hand_confidence = self.get_parameter('min_hand_confidence').value
        
        self.create_subscription(String, '/sensors/leapDesk/json', self.leap_subscriber_callback, qos_profile=1)
        ...
        if hands:
            ...
            if hand.get('confidence') > self.min_hand_confidence:
                ...
                if len(joint_positions) > 0:
                    ...
                    hand_pos = leap_to_jaka(palm_position)
